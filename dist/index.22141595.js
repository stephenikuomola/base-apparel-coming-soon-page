...
class FormComponent {
    ...
    #checkUserInput() {
        ...
        if (this.#email.validity.valid) this.#resetErrorMessageAndIndicator();
        else this.#showErrorMessageAndIndicator();
    }
    #submitForm(evtObj) {
        if (this.#email.validity.valid) this.#resetErrorMessageAndIndicator();
        else {
    ...
    #showErrorMessageAndIndicator() {
        if (this.#email.validity.valueMissing) this.#errorMessage.textContent = "Please enter your email";
        else if (this.#email.validity.typeMismatch) this.#errorMessage.textContent = "Please provide a valid email";
...
},{}]},["lY6OU","1Gxkx"], "1Gxkx", "parcelRequireb32b")
